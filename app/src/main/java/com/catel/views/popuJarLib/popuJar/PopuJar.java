package com.catel.views.popuJarLib.popuJar;
...
public class PopuJar extends PopupWindows implements OnDismissListener {
    ...
    public void addPopuItem(PopuItem action) {
        ...
        if (mOrientation == HORIZONTAL && mChildPos != 0) {
            RelativeLayout separator = new RelativeLayout(mContext);
    ...
    public void show(View anchor) {
        ...
        if ((anchorRect.left + rootWidth) > screenWidth) {
            ...
            if (anchor.getWidth() > rootWidth) {
                ...
                xPos = anchorRect.left-anchor.getWidth()/2;
            }
        ...
        mWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, xPos, (int) (yPos + mContext.getResources().getDisplayMetrics().density * 16));
    }
